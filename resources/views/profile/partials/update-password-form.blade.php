<section>
    <header>
        <h2 class="text-lg font-medium text-gray-900">Aggiorna la <a class="text-decoration-none" href="https://bitwarden.com/download/">Password</a></h2>
        
        <p class="mt-1 text-sm text-gray-600">Assicurati di utilizzare una password lunga e randomica per mantenere in sicurezza il tuo account.</p>
    </header>
    ...
    <form method="post" action="{{ route('password.update') }}" class="mt-6 space-y-6">
        ...
        <div class="d-flex align-items-center gap-4">
            ...
            @if (session('status') === 'password-updated')
                ...
                <p id='status' class=" fs-5 text-muted">Salvata</p>
            @endif
        </div>
    </form>
</section>
